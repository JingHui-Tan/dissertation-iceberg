...
def main():
    ...
    skip_training = True
    year = "2018"
    order_type_lst = ['combined', 'combined']
    predictive_lst = [True, True]
    ret_type_lst = ["log_ret_ex", "log_ret_ex"]
    momentum_lst = [False, True]
    file_name_lst= ["all_log_ret_ex_2018.csv", "all_log_ret_ex_momentum_2018.csv"]
